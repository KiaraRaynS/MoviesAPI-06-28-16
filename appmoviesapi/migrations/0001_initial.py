    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appmoviesapi.Movie')),
            ],
        ),
        migrations.CreateModel(
            name='Rater',
        ...
        migrations.AddField(
            ...
            name='rater',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appmoviesapi.Rater'),
        ),
    ]
